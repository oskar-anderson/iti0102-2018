...
def get_data_from_id(id_code: str):
    ...
    if check_control_number(id_code) is True:
        print("This is a " + get_gender(int(id_code[0])) + " born on " + str(str(10 * int(id_code[5]) + int(id_code[6]))).zfill(2) + "." + str(str(10 * int(id_code[3]) + int(id_code[4]))).zfill(2) + "." + str(get_full_year(int(id_code[0]), ((10 * int(id_code[1])) + (int(id_code[2]))))))
    else:
